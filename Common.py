...
def UploadFilesToCdn(aDryRun):
    ...
    rsyncOptions = ['--itemize-changes', '--recursive', '--cvs-exclude', '--delete', '--checksum', '--copy-links', '--perms', '--times', '--verbose', '--exclude=/konfig/', '--exclude=/product/']  # --cvs-exclude suppresses .svn/ and much other junk
